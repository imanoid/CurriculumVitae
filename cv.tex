...
\cventry{2016--now}{Software Developer}{\textsc{Supercomputing Systems AG}}{Zürich}{}{Supercomputing Systems AG which developes outsourced software projects. During my time there I have been involved in the following projects as a software developer:
\begin{itemize}
...
\cvitem{Basic}{Bash Scripts, QT, Cuda, .NET}
\cvitem{Intermediate}{java, html, JavaScript, \LaTeX, Microsoft Windows, OpenCV, Computer Hardware, Scikit Learn, JavaFX, Iotivity}
\cvitem{Advanced}{python, C++, Linux}
...
\cvlistdoubleitem{Deep Learning}{Natural Language Processing}
